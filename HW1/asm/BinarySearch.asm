...
message3:   dw 'Enter number to seacrh', 00AH, 00H    ; null-teminated string  
message4:   dw 'Error!', 00AH, 00H    ; null-teminated string     
...
printSortedNumbers:
    ...
    LXI B, message3         ; put the address of message3 to registers
    MVI A, PRINT_STR        ; store the OS code to A
    call GTU_OS             ; call the OS
    MVI A, READ_MEM         ; store the OS code to A
    call GTU_OS             ; call the OS
    LXI B, message4         ; put the address of newline to registers
    MVI A, PRINT_STR        ; store the OS code to A
    call GTU_OS             ; call the OS
    hlt                     ; end program    
